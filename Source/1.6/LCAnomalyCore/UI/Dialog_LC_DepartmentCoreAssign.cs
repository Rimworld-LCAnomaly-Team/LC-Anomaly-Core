...
namespace LCAnomalyCore.UI
{
    ...
    /// 自动研究分配对话框
    /// </summary>
    public class Dialog_LC_DepartmentCoreAssign : Window
    {
        private CompAssignableDepartmentCore assignable;
        ...
        /// <summary>初始化 <c>Dialog_LC_DepartmentCoreAssign</c> 类的新实例。</summary>
        public Dialog_LC_DepartmentCoreAssign(CompAssignableDepartmentCore assignable)
        {
        ...
        private void DrawAssignableWorkRow(Pawn pawn, Rect rect)
        {
            ...
            {
                string text = "";
                CompPawnStatus status = pawn.GetComp<CompPawnStatus>();
                if (status != null)
                {
